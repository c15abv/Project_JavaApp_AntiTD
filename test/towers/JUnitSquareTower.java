...
public class JUnitSquareTower {
	...
	public void testNotificationFunctionality(){
		SquareTowerFigure fig = new SquareTowerFigure(0,0,0,new Position(150, 150));
		SquareCreatureFigure creature = new SquareCreatureFigure(0,0,new Position(0,0),
	...
	public void testTowerEquals(){
		SquareTowerFigure fig1 = new SquareTowerFigure(0,0,0,new Position(150, 150));
		SquareTowerFigure fig2 = new SquareTowerFigure(0,0,0,new Position(100, 100));
		SquareTowerFigure fig3 = new SquareTowerFigure(0,0,0,new Position(150, 150));
	...
	public void testFindsTargetWithinRange(){
		...
		SquareTowerFigure tFig = new SquareTowerFigure(5,180,200,
	...
	public void testDoNotFindTarget(){
		...
		SquareCreatureFigure fig = new SquareCreatureFigure(100,1,
				new Position(100,100), Orientation.RANDOM, null);
		SquareTowerFigure tFig = new SquareTowerFigure(5,180,100,
				new Position(200,200));
	...
	public void testFindsBestTargetAmongShapes(){
		...
		SquareTowerFigure tFig = new SquareTowerFigure(5,180,500,
				new Position(200,200));
	...
	public void testDoesNotAttackOnCooldown(){
		...
		SquareCreatureFigure fig1 = new SquareCreatureFigure(200,1,
				new Position(100,100), Orientation.RANDOM, null);
		SquareTowerFigure tFig = new SquareTowerFigure(5,200,500,
				new Position(200,200));
	...
	public void testDamageAgaintBadTarget(){
		...
		TriangleCreatureFigure fig1 = new TriangleCreatureFigure(20,1,
				new Position(100,100), Orientation.RANDOM, null);
		SquareTowerFigure tFig = new SquareTowerFigure(20,200,500,
				new Position(200,200));
