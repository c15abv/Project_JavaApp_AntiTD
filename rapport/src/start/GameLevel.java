...
public class GameLevel {
	 ...
	 *            The attacking player's score goal.
	 * @param levelMap
	 *            The level map.
	 * @param levelName
	 *            The level name.
	 * @param attackerCredit
	 *            The attacker's start credit.
	 * @param defenderCredit
	 *            The defender's start credit.
	 * @param timeToFinish
	 *            The time the player has to finish the level within.
	 * @param nrOfTemplates
	 *            The number of troops to create.
	 * @param nrOfX
	 ...
	 * @param landOnFiles
	 *            An ArrayList of strings containing LandOn files.
	 * @param levelMap
	 *            A HashMap containing AreaPosition objects and Tile objects.
	 */
