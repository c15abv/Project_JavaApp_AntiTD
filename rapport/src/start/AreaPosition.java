...
/**
 * The AreaPosition class describes all possible positions counting from the a
 * specific position and outward (delta).
 *
...
public class AreaPosition extends Position {
	...
	/**
	 * Creates an AreaPosition with a given Position. The delta value is fetched
	...
	/**
	 * Creates an AreaPosition with a given Position, length and height.
	 *
	 * @param position
	 *            a Position.
	 * @param length
	...
	/**
	 * Creates an AreaPosition with a given x- and y-coordinate, length and
	 * height.
	 *
	 * @param x
	 *            the x-coordinate.
	 ...
	 * @return If the position is within the area.
	 */
