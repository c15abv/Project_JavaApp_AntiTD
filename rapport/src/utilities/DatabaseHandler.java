...
public class DatabaseHandler {
	 ...
	 *
	 * @return ArrayList with HighScoreInfo objects
	 * @throws SQLException
	 *             SQLException
	 */
	 ...
	 *
	 * @param name
	 *            The player's name (user input)
	 * @param score
	 *            The player's score
	 * @param time
	 *            The time the level was finished
	 * @param level
	 *            The level the the player reached
	 * @throws SQLException
	 *             SQLException
	 */
	public void insertToDatabase(String name, int score, Time time,
