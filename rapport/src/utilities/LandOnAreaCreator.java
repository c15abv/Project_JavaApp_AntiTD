...
public class LandOnAreaCreator {
	...
	/**
	 * Used to create a tile of type PathTile dynamically
	 *
	 * @param aClassName
	 *            The class name
	 * @param position
	...
	/**
	 * Used to create a tile of type Tile dynamically
	 *
	 * @param aClassName
	 *            The class name
	 * @param position
	 *            The tile's position
	 * @return Object containing the created tile.
	 */
	 ...
	 * @param myClassObject
	 *            The class object
	 * @return True if the class object implements EnterTileEffect, otherwise
	 *         false.
	 */
	 ...
	 * @return True if the class implementer the EnterTileEffect LandOn and
	 *         extends the PathTile class, else false.
	 */
