...
/**
 * ProjectileFigure holds the basic information regarding how projectiles adhere
 * to the physics laws in the AntiTD game.
 * 
...
public abstract class ProjectileFigure {
	...
	/**
	 * Creates a new projectile with the specified hue and starting position.
	 * 
	 * @param hue
	 *            the hue.
	 * @param position
	...
	/**
	 * Updates the trajectory of the ProjectileFigure with the given
	 * CreatureFigure as reference.
	 * 
	 * @param figure
	 *            the target CreatureFigure.
	 */
	...
	/**
	 * Calculates the damage which a certain projectile would do to a certain
	 * creature.
	 * 
	 * @param shape
	 *            the shape of the projectile.
	 * @param targetShape
	 *            the shape of the target creature.
	 * @param hue
	 *            the hue of the projectile.
	 * @param targetHue
	 *            the hue of the target creature.
	 * @return a double with the calculated damage output.
	 */
	public static double calculateDamageMultiplier(Figures shape,
			Figures targetShape, int hue, int targetHue) {
		double multiplier;
	...
	/**
	 * Returns a Figures value describing the shape of the projectile.
	 * 
	 * @return a Figures value describing the shape of the projectile.
	 */
